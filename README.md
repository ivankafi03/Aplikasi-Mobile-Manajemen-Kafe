...
| Kelola Jadwal Shift | Buat, edit, dan publish jadwal shift karyawan |
...
> **Catatan:** File `firebase_options.dart` dan konfigurasi Supabase menggunakan environment project sendiri. Pastikan membuat project Firebase & Supabase baru saat ingin menjalankan secara mandiri.
...
<p align="center">
  Dibuat menggunakan Flutter & Firebase
</p>
